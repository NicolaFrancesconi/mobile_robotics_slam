...
estimated_orientation_error = np.linalg.norm(estimated_final_pose[2])

odometry_final_pose = estimated_trajectory[-1]
odometry_position_error = np.linalg.norm(estimated_final_pose[:2])
odometry_orientation_error = np.linalg.norm(estimated_final_pose[2])

icp_final_pose = estimated_trajectory[-1]
icp_position_error = np.linalg.norm(estimated_final_pose[:2])
icp_orientation_error = np.linalg.norm(estimated_final_pose[2])
